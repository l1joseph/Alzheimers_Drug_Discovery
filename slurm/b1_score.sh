...
echo "=== B1 scoring (147 NCT-503 analogues) at $(date) ==="

cd $PROJECT
boltz predict $PROJECT/data/tamgen_b1_yamls --no_kernels \
...
python $PROJECT/scripts/aggregate_boltz.py \
    --pred-dir $WORK \
    --out-csv $PROJECT/results/tamgen_b1/scores.csv
...
addrows(f'{P}/results/tamgen_b1/scores.csv', 'tamgen_b1')
